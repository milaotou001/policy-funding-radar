  ...
  return (
    <section className="mb-12">
      <button
        ...
        className="w-full text-left flex items-center justify-between py-3 border-b-2 border-zinc-200order-zinc-700 hover:border-zinc-400over:border-zinc-500 transition-colors cursor-pointer"
      >
        <h2 className="text-lg sm:text-xl font-semibold text-zinc-900ext-zinc-100">
          判断依据与方法说明
        </h2>
        <span className="text-zinc-400ext-zinc-500 text-xl transition-transform duration-200" style={{ transform: open ? "rotate(45deg)" : "rotate(0deg)" }}>
          +
        </span>
      </button>

      {open && (
        <div className="mt-4 space-y-6 text-sm leading-relaxed text-zinc-700ext-zinc-300">
          <div>
            <h3 className="font-semibold text-zinc-900ext-zinc-100 mb-2">一、产业方向筛选依据</h3>
          ...
          <div>
            <h3 className="font-semibold text-zinc-900ext-zinc-100 mb-2">二、变化类型判断标准</h3>
            <table className="w-full text-xs sm:text-sm border-collapse">
              <thead>
                <tr className="border-b border-zinc-200order-zinc-700 text-left">
              ...
              <tbody>
                <tr className="border-b border-zinc-100order-zinc-800">
                  <td className="py-1.5 pr-2 font-medium text-amber-700ext-amber-300">新增</td>
                  <td className="py-1.5 pr-2">十四五正文未提及或基本未出现，十五五首次写入纲要正文且列为独立方向</td>
                  <td className="py-1.5 text-zinc-500ext-zinc-400">低空经济、具身智能、脑机接口在十四五中无对应段落</td>
                </tr>
                <tr className="border-b border-zinc-100order-zinc-800">
                  <td className="py-1.5 pr-2 font-medium text-amber-700ext-amber-300">强化</td>
                  <td className="py-1.5 pr-2">十四五已提及，十五五中位置更靠前、措辞更强、覆盖范围扩大或优先级提升</td>
                  <td className="py-1.5 text-zinc-500ext-zinc-400">数字经济从"建设数字中国"升级为"深入推进+提升数智化水平"</td>
                </tr>
                <tr className="border-b border-zinc-100order-zinc-800">
                  <td className="py-1.5 pr-2 font-medium text-gray-500ext-gray-400">弱化</td>
                  <td className="py-1.5 pr-2">十四五重点提及，十五五中降温、措辞减弱或从独立方向降级为附属提及</td>
                  <td className="py-1.5 text-zinc-500ext-zinc-400">传统基建、房地产开发从独立章节降为附属内容</td>
                </tr>
                <tr className="border-b border-zinc-100order-zinc-800">
                  <td className="py-1.5 pr-2 font-medium text-blue-700ext-blue-300">工程化</td>
                  <td className="py-1.5 pr-2">从"培育""发展""鼓励"等软性措辞，变为"实施工程""建设平台""示范应用""规模化"等硬性项目化表述</td>
                  <td className="py-1.5 text-zinc-500ext-zinc-400">新能源从"提升规模"变为"十年倍增行动+清洁能源基地"</td>
                </tr>
                <tr>
                  <td className="py-1.5 pr-2 font-medium text-orange-700ext-orange-300">监管化</td>
                  <td className="py-1.5 pr-2">从支持发展或激励为主，转向规范治理、算法监管、整治过度竞争等约束性政策</td>
                  <td className="py-1.5 text-zinc-500ext-zinc-400">平台经济增加"算法备案""透明度管理""内卷式竞争整治"</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-zinc-900ext-zinc-100 mb-2">三、语义对齐方法</h3>
          ...
          <div>
            <h3 className="font-semibold text-zinc-900ext-zinc-100 mb-2">四、投资观察要点方法论</h3>
          ...
          <div>
            <h3 className="font-semibold text-zinc-900ext-zinc-100 mb-2">五、局限性声明</h3>
            <ul className="list-disc pl-5 space-y-1 text-zinc-500ext-zinc-400">
